...
<input type="text" name="Techonology" class="form-control input-default " value="{{ $chart->x_data }}"  >
    @error('x_data')
...
<input type="text" name="Projects" class="form-control input-default " value="{{ $chart->y_data }}"  >
    @error('y_data')
    <span class="text-danger">{{ $message }}</span>
    @enderror
