...
<div class="content-body" style="min-height: 788px;">
    ...
    <div class="form-group">
                <label class="info-title">Total Areas </label>
         <input type="text" name="total_areas" class="form-control input-default "value="{{ $homecontent->total_areas }}"  >
            @error('total_areas')
            <span class="text-danger">{{ $message }}</span>
            @enderror
                ...
                <div class="form-group">
                <label class="info-title">Total Clients </label>
         <input type="text" name="total_clients" class="form-control input-default " value="{{ $homecontent->total_clients }}" >
            @error('total_clients')
            <span class="text-danger">{{ $message }}</span>
            @enderror
