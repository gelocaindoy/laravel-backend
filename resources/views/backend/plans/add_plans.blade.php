...
<div class="content-body" style="min-height: 788px;">
 ...
 <div class="form-group">
         ...
         <input type="text" name="total_price" class="form-control input-default "  >
            @error('total_price')
            <span class="text-danger">{{ $message }}</span>
            @enderror
         ...
         <input type="text" name="total_cap" class="form-control input-default "  >
            @error('total_cap')
            <span class="text-danger">{{ $message }}</span>
            @enderror
         ...
         <input type="text" name="total_mbps" class="form-control input-default "  >
            @error('total_mbps')
            <span class="text-danger">{{ $message }}</span>
            @enderror
 ...
 <div class="form-group">
         ...
         <input type="text" name="video_url" class="form-control input-default "  >
           ...
           <input type="submit" class="btn btn-success" value="Add Plans">
